(function($) {
 ...
 // JavaScript to handle trip type selection
...
// JavaScript to handle trip type selection and toggle return fields
    function selectTripType(tripType) {
        const oneWayButton = document.getElementById("one-way");
        const roundTripButton = document.getElementById("round-trip");
        ...
        if (tripType === "one-way") {
            oneWayButton.classList.add("active");
            roundTripButton.classList.remove("active");
            returnSection.style.display = "none"; // Hide return section for one-way trip
        } else {
            roundTripButton.classList.add("active");
            oneWayButton.classList.remove("active");
            returnSection.style.display = "block"; // Show return section for round trip
        }
    }
...
setInterval(nextSlide, 5000);
 ...
 function sendWhatsApp() {
        ...
        var phoneNumber = "919344772753"; // Replace with your WhatsApp number
    var url = "https://wa.me/ 919344772753" + "?text=" + message;
